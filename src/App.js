...
import PageDefault from '../src/components/PageDefault/index';
import BannerMain from './components/BannerMain';
import Carousel from './components/Carousel';
import categoriasRepository from '../src/repositories/dadosCategorias'
        ...
        if (indice === 0) {
          return (
            <div key={categoria.id}>
              <BannerMain videoTitle={dadosIniciais[0].videos[0].titulo}
